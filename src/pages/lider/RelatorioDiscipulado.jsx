...
function RDStyles({ t, isDark }) {
  return (
      ...
      .rd-date-bar {
        padding: 16px 22px;
        display: flex; align-items: center; gap: 12; flex-wrap: wrap;
      }
      .rd-date-input {
      ...
      .rd-banner-sub {
        font-size: 11px; font-weight: 300; color: ${t.textSec}; margin: 0;
      }
      ...
      .rd-btn-blue {
        ...
        color: #fff;
        box-shadow: 0 8px 28px rgba(0,61,165,.22);
      }
                ...
                return (
                    <button
                        ...
                        style={{
                          ...
                          background: sel
                              ? (isDark ? "rgba(201,169,110,.15)" : "rgba(201,169,110,.1)")
                              : "transparent",
                    ...
                    >
                      ...
                      <span style={{
                        ...
                        color: sel ? AURA.gold : t.textSec,
                      }}>{opcao.toUpperCase()}</span>
                    </button>
                );
              })}
            </div>
          ...
          <div style={{ display: "flex", gap: 10 }}>
            ...
            <button
                ...
                style={{
                  ...
                  letterSpacing: ".14em", textTransform: "uppercase", color: "#0A0A0F",
                  boxShadow: "0 4px 14px rgba(201,169,110,.25)", transition: "all .15s",
                }}
            >Confirmar</button>
          </div>
        </div>
  ...
  return (
      <div className="rd-card" style={{ overflow: "hidden" }}>
        <div style={{ padding: "20px 22px", borderBottom: `1px solid ${t.border}`, display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 15, fontWeight: 500, color: t.text }}>Histórico de Discipulado</span>
          ...
          Últimas {slice.length} semana{slice.length !== 1 ? "s" : ""}
        </span>
        </div>
        {slice.map((item) => {
              ...
              <div key={item.id} className="rd-hist-row">
                <div style={{ flex: 1 }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                    ...
                    <span className="rd-hist-date">{item.inicio} → {item.fim}</span>
                  </div>
                  <div className="rd-hist-stats">
                    <span className="rd-hist-stat">{item.totalMembros ?? "?"} membros</span>
                    <span className="rd-hist-stat">{totalPresencas} presenças</span>
                    <span style={{ fontFamily: "'Inter',sans-serif", fontSize: 9, fontWeight: 700, letterSpacing: ".12em", textTransform: "uppercase", color: pct > 60 ? AURA.gold : AURA.red }}>
                  {pct}% freq.
                </span>
                  </div>
                  <div className="rd-hist-bar">
                    <div style={{ height: "100%", width: `${pct}%`, borderRadius: 99, background: pct > 60 ? `linear-gradient(90deg,${AURA.gold},${AURA.goldLight})` : `linear-gradient(90deg,${AURA.red},${AURA.blue})`, transition: "width .4s ease" }} />
                  </div>
                </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
        ...
        <div className="rd-card" style={{ padding: "18px 22px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <button
                onClick={onVoltar}
                style={{ background: "none", border: "none", cursor: "pointer", padding: 6, color: AURA.gold, display: "flex", alignItems: "center" }}
            >
              <ChevronLeft size={20} />
            </button>
            <div>
...
export default function RelatorioDiscipulado({ isDark = false }) {
  ...
  if (loading) return (
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "64px 0", gap: 14 }}>
        <style>{`@import url('https://fonts.googleapis.com/css2?family=Playfair+Display:wght@500&family=Inter:wght@500&display=swap'); @keyframes rd-spin{to{transform:rotate(360deg)}} .rd-spin{animation:rd-spin 1s linear infinite}`}</style>
        <IEQCross size={40} />
      ...
      <div className="rd-root">
        ...
        <div className="rd-content">
          ...
          <div className="rd-card">
            <div className="rd-header">
              <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
                ...
                <div>
                  ...
                  <div style={{ height: 16, marginTop: 3 }}>
                    {salvouAgora && (
                        <span className="rd-saved-badge"><Save size={10} /> Rascunho salvo</span>
                    )}
                  </div>
                </div>
              </div>
              <div className="rd-tabs">
                <button
                    className={`rd-tab ${aba === "relatorio" ? "rd-tab-active" : "rd-tab-inactive"}`}
                    onClick={() => { setAba("relatorio"); setDetalheItem(null); }}
                >
                  <UserCheck size={13} /> Relatório
                </button>
                <button
                    className={`rd-tab ${aba === "historico" ? "rd-tab-active" : "rd-tab-inactive"}`}
          ...
          {aba === "relatorio" && (
              <>
                {/* Barra de datas */}
                <div className="rd-card rd-date-bar" style={{ gap: 12 }}>
                  <Calendar size={14} style={{ color: AURA.gold, flexShrink: 0 }} />
                  <input
                      type="date" className="rd-date-input"
                  ...
                  />
                  {verificandoExist && (
                      <Loader2 size={13} className="rd-spin" style={{ color: AURA.gold, marginLeft: "auto" }} />
                  )}
                </div>

                {/* Banner: relatório existente */}
                {relatorioExistente && !modoEdicao && (
                    <div className="rd-banner rd-banner-warn" style={{ gap: 12 }}>
                      <AlertTriangle size={18} style={{ color: AURA.yellow, flexShrink: 0 }} />
                      <div style={{ flex: 1 }}>
                        <p className="rd-banner-title" style={{ color: AURA.yellowDark }}>
                          Relatório já enviado para esta semana
                        </p>
                ...
                {/* Banner: modo edição */}
                {modoEdicao && (
                    <div className="rd-banner rd-banner-edit" style={{ gap: 12 }}>
                  ...
                  {[
                    ...
                    { label: "Frequência", val: `${stats.porcentagem}%`, color: stats.porcentagem > 60 ? AURA.gold : AURA.red, highlight: stats.porcentagem > 60 },
                      ...
                      <div
                          key={label}
                          className="rd-kpi"
                          style={highlight ? { background: `linear-gradient(135deg,${AURA.blueDark},${AURA.blue})`, border: "none" } : {}}
                      >
                        <p className="rd-kpi-label" style={highlight ? { color: "rgba(255,255,255,.55)" } : {}}>
                          {label}
                        </p>
                ...
                <span style={{ fontFamily: "'Inter',sans-serif", fontSize: 9, fontWeight: 600, letterSpacing: ".16em", textTransform: "uppercase", color: t.textMuted }}>
                  Membro
                </span>
                    {COLUNAS.map(({ label, emoji }) => (
                        <div key={label} className="rd-table-col-label">
                        ...
                        <div key={m.id} className="rd-member-row" style={{ animationDelay: `${i * 0.04}s` }}>
                          ...
                          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                            ...
                            <div style={{
                              ...
                              background: total === COLUNAS.length
                                  ? `linear-gradient(135deg,${AURA.gold},${AURA.goldLight})`
                                  : (isDark ? "rgba(201,169,110,.06)" : "rgba(201,169,110,.08)"),
                              border: `1px solid ${total === COLUNAS.length ? "transparent" : t.border}`,
                            }}>
                        <span style={{
                          fontFamily: "'Inter',sans-serif", fontSize: 9, fontWeight: 600,
                          letterSpacing: ".12em", textTransform: "uppercase",
                          color: total === COLUNAS.length ? "#0A0A0F" : t.textMuted,
                        }}>
                              ...
                              <span style={{ fontSize: 18, filter: marcado ? "none" : "grayscale(1)", opacity: marcado ? 1 : 0.4, transition: "all .2s" }}>
                                {marcado ? "✅" : emoji}
                                      ...
                                      <span style={{
                                        ...
                                        color: marcado ? AURA.gold : t.textMuted,
                                      }}>
                                {label}
                              </span>
                                    </button>
                                    {!marcado && (
                                        <button
                                            className={`rd-just-btn${temJust ? " rd-just-btn-filled" : ""}`}
                ...
                {/* Botão enviar */}
                <button
                    className={`rd-btn-submit ${modoEdicao ? "rd-btn-blue" : "rd-btn-gold"}`}
