...
const CORES_JUST      = { Trabalho: "#3D9BFF", Doença: "#FF4757", Viagem: "#22D3EE", Outro: "#FFB84D" };
  ...
  return (
    ...
    * { box-sizing: border-box; }
    ...
    .rd-eyebrow {
      ...
      text-transform: uppercase; color: rgba(184,137,46,.55); margin: 0 0 3px;
    }
    .rd-title {
      font-family: 'Inter', sans-serif;
    ...
    .rd-tab-active {
      ...
      color: #0A0A0F; box-shadow: 0 6px 20px rgba(184,137,46,.25);
    }
    .rd-tab-inactive {
      background: ${isDark ? "rgba(255,255,255,.04)" : "rgba(184,137,46,.06)"};
    ...
    .rd-banner-warn {
      background: ${isDark ? "rgba(184,137,46,.1)" : "rgba(184,137,46,.07)"};
      border: 1px solid rgba(184,137,46,.3);
    }
    .rd-banner-edit {
      background: ${isDark ? "rgba(15,42,74,.25)" : "rgba(15,42,74,.07)"};
      border: 1px solid rgba(15,42,74,.3);
    }
    .rd-banner-title {
    ...
    .rd-table-head {
      ...
      background: ${isDark ? "rgba(184,137,46,.04)" : "rgba(184,137,46,.05)"};
    }
    .rd-table-col-label {
      text-align: center;
    ...
    .rd-progress-track {
      ...
      background: ${isDark ? "rgba(255,255,255,.06)" : "rgba(184,137,46,.1)"};
      margin: 12px 0 14px;
    }
    .rd-progress-fill { height: 100%; border-radius: 99px; transition: width .4s ease; }

    /* ── Grid de presença (5 colunas responsivas, sempre visíveis) ── */
    .rd-presence-grid {
      display: grid;
    ...
    .rd-presence-btn {
      ...
      padding: 10px 4px; border-radius: 12px; border: 1px solid; cursor: pointer;
    ...
    /* Label do culto sempre empilhada: tipo em cima, dia embaixo */
    .rd-pb-label {
    ...
    .rd-pb-label-dia {
      font-size: 7px; font-weight: 500; letter-spacing: .04em; opacity: .8;
      max-width: 100%; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;
    }

    .rd-just-btn {
      margin-top: 5px; padding: 4px 8px; border-radius: 99px;
      border: 1px solid rgba(184,137,46,.25); background: transparent; cursor: pointer;
    ...
    .rd-just-btn:hover { border-color: rgba(184,137,46,.5); color: ${AURA.gold}; }
    .rd-just-btn-filled {
      border-color: rgba(184,137,46,.6) !important;
      background: ${isDark ? "rgba(184,137,46,.12)" : "rgba(184,137,46,.1)"} !important;
    ...
    .rd-btn-gold {
      background: linear-gradient(135deg, ${AURA.gold}, ${AURA.goldLight});
      color: #0A0A0F; box-shadow: 0 8px 28px rgba(184,137,46,.25);
    }
    .rd-btn-blue {
      background: linear-gradient(135deg, ${AURA.blueDark}, ${AURA.blue});
      color: #fff; box-shadow: 0 8px 28px rgba(15,42,74,.4);
    }
    ...
    .rd-toast-draft {
      ...
      background: ${isDark ? "rgba(15,42,74,.3)" : "rgba(15,42,74,.06)"};
    ...
    .rd-btn-edit-gold {
      ...
      box-shadow: 0 4px 14px rgba(184,137,46,.2);
    }
    .rd-btn-edit-gold:hover { transform: translateY(-1px); box-shadow: 0 8px 22px rgba(184,137,46,.3); }

    /* ── Detalhe histórico ── */
    .rd-detail-grid {
      display: grid; grid-template-columns: 1fr repeat(5, minmax(0,1fr));
      padding: 12px 22px; gap: 6px; align-items: center;
    }
    ...
    /* ══════════════════════════════════════════════════════════════════
       TABLET / TELAS MÉDIAS (<= 700px)
       Reduz paddings e fontes para acomodar melhor a grade de presença.
    ══════════════════════════════════════════════════════════════════ */
    @media(max-width: 700px) {
      .rd-content { padding: 0 12px; }
      .rd-member-row { padding: 18px 16px; }
    ...
    /* ══════════════════════════════════════════════════════════════════
       ...
       e o cabeçalho de coluna (desktop) é ocultado — cada botão já mostra
       seu próprio rótulo empilhado (tipo do culto + dia).
    ══════════════════════════════════════════════════════════════════ */
    @media(max-width: 480px) {
      .rd-header     { padding: 20px 14px; gap: 12px; }
      .rd-tabs       { width: 100%; }
      ...
      .rd-pag        { padding: 12px 12px; }
      .rd-pag-info   { font-size: 8.5px; }
      .rd-pag-btn    { width: 29px; height: 29px; }
      ...
      .rd-member-row     { padding: 15px 10px; }
      .rd-member-avatar  { width: 32px; height: 32px; font-size: 13px; border-radius: 9px; }
      .rd-member-name    { font-size: 13px; }
    ...
    /* ══════════════════════════════════════════════════════════════════
       TELAS MUITO ESTREITAS (<= 360px) — ex: iPhone SE
    ══════════════════════════════════════════════════════════════════ */
    @media(max-width: 360px) {
      .rd-member-row     { padding: 13px 8px; }
      .rd-presence-btn   { padding: 6px 1px 5px; }
    ...
    @media(max-width: 320px) {
      .rd-pb-label-dia { display: none; } /* telas extremamente estreitas: só tipo + ícone */
    }
      ...
      <div className="rd-modal-overlay" onClick={onFechar}>
        <div className="rd-modal-box" onClick={(e) => e.stopPropagation()}>
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 17, fontWeight: 600, color: selecionado ? CORES_JUST[selecionado] : AURA.goldLight, textShadow: selecionado ? `0 0 16px ${CORES_JUST[selecionado]}66` : "0 0 16px rgba(184,137,46,.5)", margin: "0 0 3px", transition: "color .25s, text-shadow .25s" }}>
              {nomeMembro}
            </p>
                ...
                return (
                    <button key={opcao} onClick={() => setSelecionado(sel ? "" : opcao)}
                            ...
                            style={{
                              ...
                              background: sel ? (isDark ? "rgba(184,137,46,.15)" : "rgba(184,137,46,.1)") : "transparent",
                              transform: sel ? "scale(1.04)" : "scale(1)",
                              boxShadow: sel ? "0 4px 16px rgba(184,137,46,.2)" : "none",
                            }}
                    >
  ...
  return (
      <div className="rd-toast-overlay" style={{ animation: saindo ? "rd-overlOut .45s ease forwards" : "rd-overlIn .3s ease forwards" }}>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 0, animation: saindo ? "rd-toastOut .45s cubic-bezier(.4,0,.6,1) forwards" : "rd-toastIn .55s cubic-bezier(.34,1.56,.64,1) forwards" }}>
          ...
          <div className="rd-toast-box" style={{ background: `linear-gradient(160deg, ${c1} 0%, ${c2} 60%, ${c3} 100%)`, boxShadow: modoEdicao ? "0 16px 60px rgba(15,42,74,.5)" : "0 16px 60px rgba(13,110,58,.5)" }}>
            ...
            <div style={{ textAlign: "center" }}>
              <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 18, fontWeight: 600, color: "#fff", margin: "0 0 8px", letterSpacing: ".04em" }}>
            ...
            <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "center" }}>
              ...
              <div style={{ background: "rgba(184,137,46,.25)", border: "1px solid rgba(184,137,46,.4)", borderRadius: 100, padding: "5px 14px", fontFamily: "'Inter',sans-serif", fontSize: 9, fontWeight: 600, letterSpacing: ".14em", textTransform: "uppercase", color: AURA.goldLight, display: "flex", alignItems: "center", gap: 6 }}>
                ⭐ {totalPontos} Pontos
              </div>
              <div style={{ background: porcentagem >= 60 ? "rgba(184,137,46,.2)" : "rgba(200,16,46,.15)", border: `1px solid ${porcentagem >= 60 ? "rgba(184,137,46,.35)" : "rgba(200,16,46,.3)"}`, borderRadius: 100, padding: "5px 14px", fontFamily: "'Inter',sans-serif", fontSize: 9, fontWeight: 600, letterSpacing: ".14em", textTransform: "uppercase", color: porcentagem >= 60 ? AURA.gold : "rgba(255,255,255,.85)", display: "flex", alignItems: "center", gap: 6 }}>
                <CheckCircle2 size={11} /> {porcentagem}% Freq.
              </div>
            </div>
            <p style={{ fontFamily: "'Inter',sans-serif", fontStyle: "italic", fontSize: 13, color: "rgba(255,255,255,.45)", textAlign: "center", margin: 0, lineHeight: 1.5 }}>
...
function AbaHistorico({ isDark, onVerDetalhe }) {
  ...
  if (historico.length === 0 && totalElements === 0) return (
      <div style={{ padding: "48px 0", textAlign: "center" }}>
        <History size={36} style={{ color: AURA.gold, marginBottom: 12 }} />
  ...
  return (
      <div className="rd-card" style={{ overflow: "hidden" }}>
        ...
        <div className="rd-hist-head">
          <div style={{ width: 28, height: 28, borderRadius: 8, background: "rgba(184,137,46,.08)", border: `1px solid ${t.border}`, display: "flex", alignItems: "center", justifyContent: "center", color: AURA.gold, flexShrink: 0 }}>
            <History size={14} />
          </div>
          <span style={{ fontFamily: "'Inter',sans-serif", fontSize: 15, fontWeight: 500, color: t.text }}>
        ...
        <div className="rd-card" style={{ padding: "18px 22px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0 }}>
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <p style={{ fontFamily: "'Inter',sans-serif", fontSize: 15, fontWeight: 500, color: t.text, margin: 0, wordBreak: "break-word" }}>
                    {formatarDataBR(item.inicio)} <span className="rd-date-sep">→</span> {formatarDataBR(item.fim)}
              </p>
            </div>
          </div>
                        ...
                        <div key={p.membroId ?? i} style={{ borderBottom: i < presencas.length - 1 ? `1px solid ${t.border}` : "none" }}>
                          ...
                          <span style={{ fontSize: 18, filter: p[campo] ? "none" : "grayscale(1)", opacity: p[campo] ? 1 : 0.25 }}>
                            {p[campo] ? "✅" : emoji}
                                  ...
                                  {!p[campo] && p[justField] && (
                                      <div style={{ fontSize: 8, color: AURA.gold, fontFamily: "'Inter',sans-serif", fontWeight: 600, textAlign: "center", lineHeight: 1.3, padding: "2px 5px", background: "rgba(184,137,46,.1)", borderRadius: 99, border: "1px solid rgba(184,137,46,.25)" }}>
                                        {p[justField]}
                                      </div>
                                  )}
                                </div>
                  ...
                  <div className="rd-table-scroll">
                    <div className="rd-table-inner">
                      ...
                      {membros.map((m, i) => {
                        ...
                        /* cor do nome do membro reage às marcações de presença — tons vívidos */
                        const nomeCor = total === COLUNAS.length
                            ? "#2ED573"  // verde vívido — presença completa
                            : total > 0
                                ? "#D97757"  // terracota/rosé elegante — presença parcial
                                : t.text;
                        const avatarBg = total === COLUNAS.length
                            ? "linear-gradient(135deg, rgba(46,213,115,.28), rgba(46,213,115,.08))"
                            : total > 0
                                ? "linear-gradient(135deg, rgba(217,119,87,.28), rgba(217,119,87,.08))"
                                : "linear-gradient(135deg, rgba(184,137,46,.2), rgba(184,137,46,.06))";
                        ...
                        const nomeGlow = total === COLUNAS.length
                            ...
                            : total > 0
                                ? "0 0 14px rgba(217,119,87,.4)"
                                : "none";
                        return (
                            <div key={m.id} className="rd-member-row" style={{ animationDelay: `${i * 0.04}s` }}>
                              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                                  <div className="rd-member-avatar" style={{ background: avatarBg, borderColor: avatarBorder, color: nomeCor, transition: "background .3s, border-color .3s, color .3s" }}>{m.nome.charAt(0)}</div>
                                  <div>
                                    <p className="rd-member-name" style={{ color: nomeCor, fontWeight: total > 0 ? 700 : 500, textShadow: nomeGlow }}>{m.nome}</p>
                                    <p className="rd-member-id">ID #{m.id}</p>
                                  </div>
                                </div>
                                <div style={{ padding: "4px 14px", borderRadius: 100, background: total === COLUNAS.length ? `linear-gradient(135deg,${AURA.gold},${AURA.goldLight})` : (isDark ? "rgba(184,137,46,.06)" : "rgba(184,137,46,.08)"), border: `1px solid ${total === COLUNAS.length ? "transparent" : t.border}` }}>
                            <span style={{ fontFamily: "'Inter',sans-serif", fontSize: 9, fontWeight: 600, letterSpacing: ".12em", textTransform: "uppercase", color: total === COLUNAS.length ? "#0A0A0F" : t.textMuted }}>
                              ...
                              <div className="rd-presence-grid">
                                {COLUNAS.map(({ campo, tipoLabel, diaLabel, label, emoji, justField, offset }) => {
                                  ...
                                  return (
                                      <div key={campo} style={{ display: "flex", flexDirection: "column", alignItems: "center", minWidth: 0, width: "100%" }}>
                                        <button
                                            ...
                                            style={{
                                              borderColor: marcado
                                                  ...
                                                  : temJust
                                                      ...
                                                      : t.border,
                                              background: marcado
                                                  ? (isDark ? "rgba(184,137,46,.1)" : "rgba(184,137,46,.07)")
                                                  : temJust
