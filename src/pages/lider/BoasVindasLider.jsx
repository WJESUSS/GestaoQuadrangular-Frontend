...
export default function BoasVindasLider({ usuarioLogado, celula, isDark, onClose }) {
    ...
    return (
        <AnimatePresence>
            {/* OVERLAY — scroll aqui, não no card */}
            <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
            ...
            >
                ...
                >
                    ...
                    <motion.div
                        ...
                        style={{
                            background: isDark
                                ? "linear-gradient(135deg,#110A0D,#0A0608)"
                            ...
                            maxWidth: 540,
                            width: "100%",
                            boxShadow: "0 25px 50px rgba(200,16,46,.15), 0 0 0 1px rgba(200,16,46,.1)",
                            position: "relative",
                        }}
                    >
                        {/* Faixa topo */}
                        ...
                        <button
                            ...
                            style={{
                                ...
                                color: textSecondary, padding: 8, borderRadius: 8,
                        ...
                        >
                            ...
                            <h1 style={{
                                fontFamily: "'Cinzel',serif", fontSize: 28, fontWeight: 700, letterSpacing: ".15em",
                                background: `linear-gradient(90deg,${IEQ.redDark},${IEQ.red},${IEQ.yellow},${IEQ.blue})`,
                        ...
                        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
                            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
                                ...
                                <button
                                    ...
                                    style={{
                                        fontFamily: "'Cinzel',serif", fontSize: 9, fontWeight: 700, letterSpacing: ".12em",
                                    ...
                                    {metas.map((meta, idx) => {
                                        ...
                                        return (
                                            <motion.div
                                                ...
                                                style={{
                                                    padding: 16, borderRadius: 12, border: `2px solid ${cor}`,
                                                ...
                                                <div style={{ position: "relative", zIndex: 1 }}>
                                                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10, flexWrap: "wrap", gap: 6 }}>
                                                        ...
                                                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                                                            {badge && !meta.metaConcluida && (
                                                                <span style={{
                                                                    fontFamily: "'Cinzel',serif", fontSize: 9, fontWeight: 700, letterSpacing: ".1em",
                                                    ...
                                                    <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", marginBottom: 12 }}>
                                                        ...
                                                        <div style={{ textAlign: "right" }}>
                                                            ...
                                                            <p style={{
                                                                fontFamily: "'Cinzel',serif", fontSize: 9, letterSpacing: ".09em", color: textSecondary,
                                                    ...
                                                    {meta.metaConcluida && (
                                                        <motion.p
                                                            ...
                                                            style={{ fontFamily: "'Cinzel',serif", fontSize: 10, letterSpacing: ".12em", color: "#22c55e", margin: "8px 0 0", textAlign: "center" }}
                                                        >
                                                            🎉 META CONCLUÍDA!
                                                        </motion.p>
                                                    )}
                        ...
                        <motion.div
                            ...
                            style={{
                                ...
                                background: isDark ? "rgba(0,61,165,.08)" : "rgba(0,61,165,.06)",
                        ...
                        <button
                            ...
                            style={{
                                ...
                                fontFamily: "'Cinzel',serif", fontSize: 11, fontWeight: 700, letterSpacing: ".15em",
                            ...
                            >
                                ...
                                <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            value={novaMetaTipo} onChange={e => setNovaMetaTipo(e.target.value)}
                                            style={{
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="number" min="1" max="100" value={novaMetaTotal}
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="date" value={novaMetaData} onChange={e => setNovaMetaData(e.target.value)}
                                            style={{
                                                width: "100%", padding: "10px 12px", borderRadius: 8,
                                                border: `1px solid ${isDark ? "rgba(200,16,46,.2)" : "rgba(200,16,46,.15)"}`,
                                                background: isDark ? "rgba(255,255,255,.04)" : "rgba(0,0,0,.02)",
                                        ...
                                        />
                                        {novaMetaData && (
                                            <div style={{ marginTop: 8, padding: "7px 12px", borderRadius: 8, background: `${corPreview}10`, border: `1px solid ${corPreview}30` }}>
                                    ...
                                    <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
                                        <button
                                            onClick={() => setShowModalMeta(false)}
                                            style={{
                                                flex: 1, fontFamily: "'Cinzel',serif", fontSize: 10, fontWeight: 700, letterSpacing: ".12em",
                                        ...
                                        <button
                                            onClick={criarNovaMeta} disabled={criandoMeta}
                                            style={{
                                                flex: 2, fontFamily: "'Cinzel',serif", fontSize: 10, fontWeight: 700, letterSpacing: ".12em",
                                                background: `linear-gradient(135deg,${IEQ.redDark},${IEQ.red})`, color: IEQ.white,
