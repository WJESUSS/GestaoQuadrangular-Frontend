        ...
        <div className="ieq-page-padding" style={{ position:"relative", zIndex:10, maxWidth:1200, margin:"0 auto", padding:"32px 24px 0" }}>
          ...
          >
            ...
            <div className="ieq-header-actions" style={{ display:"flex", alignItems:"center", gap:10, flexShrink:0 }}>
              ...
              {abaAtiva !== "home" && (
                  <button className={`ieq-btn-ghost ${t}`} onClick={() => setAbaAtiva("home")}>← VOLTAR</button>
              )}
              <button className="ieq-btn-primary" onClick={handleLogout}>SAIR</button>
            </div>
          </motion.header>
                ...
                >
                    ...
                    <div className={`ieq-card ${t} ieq-card-action`} style={{ padding:30, display:"flex", flexDirection:"column", justifyContent:"space-between" }}>
                      ...
                      <div style={{ marginTop:20 }}>
                        {isAnalise ? (
                            ...
                            <button className={`ieq-btn-ghost ${t}`} style={{ width:"100%" }} onClick={() => setAbaAtiva("relatorio")}>
                              LANÇAR RELATÓRIO
                            </button>
                        )}
                      </div>
                  ...
                  <div className="ieq-menu-grid">
                    {[
                      ...
                      { icon:<Home size={20}/>,       title:"CASAS DE PAZ",desc:"Evangelismo", aba:"casas",       color:IEQ.blue    },
      ...
      <div style={{ padding:"20px 18px", display:"flex", flexDirection:"column", flex:1, minHeight:0 }}>
        ...
        <div style={{ flex:1, overflowY:"auto", display:"flex", flexDirection:"column", gap:8, minHeight:0 }}>
          {loading ? (
              ...
              <div key={m.id} style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"9px 12px", gap:8, background: isDark ? "rgba(255,255,255,.03)" : "rgba(200,16,46,.04)", border:`1px solid ${isDark ? "rgba(200,16,46,.1)" : "rgba(200,16,46,.08)"}`, borderRadius:8, flexShrink:0 }}>
                <div style={{ display:"flex", alignItems:"center", gap:10, minWidth:0 }}>
