...
export default function PainelPastor() {
  ...
  async function carregarDados() {
    ...
    try {
      const [resMetricas, resAlertas] = await Promise.all([
        api.get("/pastor/metricas", { params: { mes } }),      // ✅ removido /api duplicado
        api.get("/discipulado/alertas", { params: { mes } }),  // ✅ sem token manual (interceptor cuida)
      ]);
  ...
  async function carregarAniversariantes() {
    try {
      const res = await api.get("/aniversariantes/hoje"); // ✅ usa api axios com interceptor
      console.log("Aniversariantes:", res.data);
