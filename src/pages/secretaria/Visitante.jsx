...
export default function Visitantes({ isDark = false }) {
  ...
  const styles = `
    ...
    @media(hover:hover) {
      .ieq-visit-card:hover { transform: translateY(-3px); box-shadow: 0 12px 32px rgba(124,58,237,.12); border-color: ${purple}; }
    }
    ...
    @media(min-width: 520px) {
      .ieq-modal-backdrop { align-items: center; padding: 16px; }
    }
    ...
    /* Drag handle no modal mobile — fica embaixo do conteúdo agora */
    .modal-handle {
      display: none;
    }
    ...
    .btn-novo {
      ...
      border: none;
      cursor: pointer;
      background: linear-gradient(135deg, ${purpleDark}, ${purple});
      color: #fff;
      font-family: 'Cinzel', serif;
      font-size: 10px;
      font-weight: 700;
                    ...
                    <motion.div key={v.id} className="ieq-visit-card"
                      ...
                      {v.convertido && (
                          <div style={{ position: "absolute", top: 0, right: 0,
                            ...
                            letterSpacing: ".12em", display: "flex", alignItems: "center", gap: 4 }}>
                            <Heart size={8} fill="#fff" /> DECIDIDO
                          </div>
                      )}
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
                        <div style={{ width: 44, height: 44, borderRadius: 10, flexShrink: 0,
                          ...
                          display: "flex", alignItems: "center", justifyContent: "center",
                          color: purple, fontFamily: "'Cinzel',serif", fontWeight: 700, fontSize: 17,
                        ...
                        <div style={{ minWidth: 0, flex: 1 }}>
                          <h4 style={{ fontFamily: "'Cinzel',serif", fontSize: 11, fontWeight: 700,
                            ...
                            overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
                            paddingRight: v.convertido ? 72 : 0 }}>
                            {v.nome}
                          </h4>
                      ...
                      {v.dataPrimeiraVisita
                        ...
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between",
                          ...
                          border: `1px solid ${purple}22`, marginTop: 2 }}>
                          <div style={{ minWidth: 0, flex: 1 }}>
                            <p style={{ fontFamily: "'Cinzel',serif", fontSize: 7.5, letterSpacing: ".14em",
                              color: textSec, margin: "0 0 2px" }}>ACOMPANHAMENTO</p>
                            <p style={{ fontFamily: "'EB Garamond',serif", fontSize: 13, color: purple,
                              margin: 0, fontStyle: "italic",
                              overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                              {v.responsavelAcompanhamento || "A definir"}
                            </p>
                          </div>
                          <ChevronRight size={14} style={{ color: textSec, flexShrink: 0, marginLeft: 6 }} />
                        </div>
                      </div>
                    </motion.div>
                ))}
